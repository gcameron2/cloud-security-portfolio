# Cloud Security Portfolio — Gabriel Cameron

Junior Systems Administrator | Cloud Security Focus
...
I'm a junior sysadmin focused on landing a cloud security role. These projects are built in a real AWS environment — not simulations — to develop the skills that matter on day one: reading audit findings, writing IaC, understanding compliance controls, and documenting decisions clearly.
